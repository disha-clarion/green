...
const WrArCompositeMatlCheck = new mongoose.Schema({
  _id: String,
  matlName: {
    type: String,
    default: ''
...
export default mongoose.model<IWrArCompositeMatlCheck & mongoose.Document>('wrArCompositeMatlCheck', WrArCompositeMatlCheck, 'wrArCompositeMatlCheck');