...
import { convertToBar, getErrorMessage } from "../helpers";
...
export default class ORingGlandAnalysisService {
    ...
    public async pressInCalculation(data: IWrArCalculatorRequest): Promise<any> {
        try {
            ...
            const stationaryMaterialResult: IWrArMaterial = await this.getMaterialDetail(data.stationaryMaterial, (+data.unit), (+data.customRotatingMaterial), (+data.customStationaryMaterial));
            ...
            const rotatingMaterialResult: IWrArMaterial = await this.getMaterialDetail(data.rotatingMaterial, (+data.unit), (+data.customRotatingMaterial), (+data.customStationaryMaterial));
            // get stator value based on selected "stationary material"
    ...
    private async getMaterialDetail(material: any, unit: Units, customRotorCTE?: any, customStatorCTE?: any): Promise<IWrArMaterial> {
    ...
    private async getMatlCheck(unit: Units, composite: any): Promise<IWrArCompositeMatlCheck> {
