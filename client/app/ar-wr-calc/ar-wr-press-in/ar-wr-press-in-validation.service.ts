...
} from "../../shared/directives/custom-validations/comparison-validation.directive";
    ...
    return (control: FormGroup): ValidationErrors | null => {
      ...
      if (serviceStorageTemperatureAmbient75FMinControl
        ...
        if ((+currentSelectedUnit.id) === Units.INCH) {
          serviceStorageTemperatureAmbient75FMinError = largerThanValidation(serviceStorageTemperatureAmbient75FMinControl.value,
            "75", "serviceStorageTemperatureAmbient75FMin",
            "Minimum Temperature", "Must be 75°F or less");
        }
        else if ((+currentSelectedUnit.id) === Units.MILLI_METER) {
          serviceStorageTemperatureAmbient75FMinError = largerThanValidation(serviceStorageTemperatureAmbient75FMinControl.value,
            "24", "serviceStorageTemperatureAmbient75FMin",
            "Minimum Temperature", "Must be 24°C or less");
        }
  ...
  serviceStorageTemperatureMaxValidation(): ValidatorFn {
    return (control: FormGroup): ValidationErrors | null => {
      ...
      if (serviceStorageTemperatureAmbient75FMaxControl
        ...
        if ((+currentSelectedUnit.id) === Units.INCH) {
          serviceStorageTemperatureAmbient75FMaxError = lessThanValidation(serviceStorageTemperatureAmbient75FMaxControl.value,
            "75", "serviceStorageTemperatureAmbient75FMax",
            "Maximum Temperature", "Must be 75°F or more");
        }
        else if ((+currentSelectedUnit.id) === Units.MILLI_METER) {
          serviceStorageTemperatureAmbient75FMaxError = lessThanValidation(serviceStorageTemperatureAmbient75FMaxControl.value, "24",
            "serviceStorageTemperatureAmbient75FMax",
            "Maximum Temperature", "Must be 24°C or more");
        }
